...
`DO_NOT_FILE`, and so does check 3's wrong-repository property — a claim that does not hold, a
duplicate, something already fixed, or a fix that lives in another repository is still
