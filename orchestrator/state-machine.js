...
async function handleImplement(ctx) {
  ...
  // (orchestrator/steps/llm.js:1009 calls `resolveStepContract(stepName, ctx.task || {})`), never
...
// (see step-contracts.js:1087's own `touchesRdoMembers === true` for the class of bug this
// forecloses).
