...
async function handleImplement(ctx) {
  ...
  // (orchestrator/steps/llm.js:978 calls `resolveStepContract(stepName, ctx.task || {})`), never
...
// (see step-contracts.js:951's own `touchesRdoMembers === true` for the class of bug this
// forecloses).
