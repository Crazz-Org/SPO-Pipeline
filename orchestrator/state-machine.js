...
async function handleImplement(ctx) {
  ...
  // (orchestrator/steps/llm.js:1049 calls `resolveStepContract(stepName, ctx.task || {})`), never
...
// (see step-contracts.js:1078's own `touchesRdoMembers === true` for the class of bug this
// forecloses).
