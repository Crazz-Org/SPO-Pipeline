...
// `continue`. Only a machine re-enqueue's resume (#251: its own, or a carried `continue`) keeps it,
// only since the last human reset. So it can never answer "how many has this card burned overall".
