...
async function processConfirmedReport(entry, journalRoot, config, deps = {}, opts = {}) {
  ...
  if (!claim.claimed) {
    ...
    // precedent guards park-loop.js:1453, the same appendDaemonEvent guard sits at
    // remote-report-pull.js:193, and appendDaemonEvent again at state-machine.js:3392 (plus this
