...
// llm.js:1219) passes `override.jsonSchema` straight through into opts.jsonSchema with no
...
function buildQueryOptions(opts, deps = {}) {
  ...
  if (opts.jsonSchema) {
    ...
    // path, llm.js:1219's `jsonSchema: override.jsonSchema` (F2, Opus verifier, fix pass: not
