...
const EXPECTED_CITATIONS = [
  ...
  "orchestrator/README.md :: intake.js:906-908", // re-pinned from :797-799, then :854-856 by issue #196's own action (+57 lines), then :869-871; the Priority-as-a-field action (2026-09-12) added 37 lines to intake.js above triageBugReport's own header comment (VALID_PRIORITIES and its rationale, canonicalPriority, the contract check, the review placeholder, the priority correction branch and fileCard's applied-priority return). A TRUE pure shift: content byte-identical at :906-908, diffed line by line against the pre-action file.
  ...
  "orchestrator/park-loop.js :: intake.js:906-908", // re-pinned from :797-799, then :854-856 by issue #196's own action (+57 lines), then :869-871; the Priority-as-a-field action (2026-09-12) added 37 lines to intake.js above triageBugReport's own header comment (VALID_PRIORITIES and its rationale, canonicalPriority, the contract check, the review placeholder, the priority correction branch and fileCard's applied-priority return). A TRUE pure shift: content byte-identical at :906-908, diffed line by line against the pre-action file.
