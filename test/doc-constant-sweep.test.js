...
const EXPECTED_CITATIONS = [
  ...
  "doc/state-machine-spec.md :: intake.js:889-891", // re-pinned from :797-799, then :854-856 by issue #196's own action (+57 lines), then :869-871; the Priority-as-a-field action (2026-09-12) added 20 lines to intake.js above triageBugReport's own header comment (VALID_PRIORITIES, the contract check, the review placeholder, the priority correction branch and fileCard's applied-priority return). A TRUE pure shift: content byte-identical at :889-891, verified line by line against HEAD.
  "orchestrator/README.md :: .claude/hooks/context-router.sh:117",
  "orchestrator/README.md :: .claude/settings.json:109-127",
  ...
  "orchestrator/README.md :: intake.js:889-891", // re-pinned from :797-799, then :854-856 by issue #196's own action (+57 lines), then :869-871; the Priority-as-a-field action (2026-09-12) added 20 lines to intake.js above triageBugReport's own header comment (VALID_PRIORITIES, the contract check, the review placeholder, the priority correction branch and fileCard's applied-priority return). A TRUE pure shift: content byte-identical at :889-891, verified line by line against HEAD.
  ...
  "orchestrator/park-loop.js :: intake.js:889-891", // re-pinned from :797-799, then :854-856 by issue #196's own action (+57 lines), then :869-871; the Priority-as-a-field action (2026-09-12) added 20 lines to intake.js above triageBugReport's own header comment (VALID_PRIORITIES, the contract check, the review placeholder, the priority correction branch and fileCard's applied-priority return). A TRUE pure shift: content byte-identical at :889-891, verified line by line against HEAD.
  ...
  "orchestrator/steps/llm.js :: intake.js:889-891", // re-pinned from :797-799, then :854-856 by issue #196's own action (+57 lines), then :869-871; the Priority-as-a-field action (2026-09-12) added 20 lines to intake.js above triageBugReport's own header comment (VALID_PRIORITIES, the contract check, the review placeholder, the priority correction branch and fileCard's applied-priority return). A TRUE pure shift: content byte-identical at :889-891, verified line by line against HEAD.
