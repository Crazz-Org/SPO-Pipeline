...
const EXPECTED_CITATIONS = [
  ...
  "doc/state-machine-spec.md :: intake.js:922-924", // re-pinned from :797-799, then :854-856 by issue #196's own action (+57 lines), then :869-871; the Priority-as-a-field action (2026-09-12) added 37 lines to intake.js above triageBugReport's own header comment (VALID_PRIORITIES and its rationale, canonicalPriority, the contract check, the review placeholder, the priority correction branch and fileCard's applied-priority return). A TRUE pure shift: content byte-identical at :906-908, diffed line by line against the pre-action file. Shifted again to :922-924 by card #198's drop (2026-09-12), which wrote that card's whole finding into amendCard's own label block as a 16-line warning instead of leaving it parked on a closed issue -- diffed byte-identical again.
  "orchestrator/README.md :: .claude/hooks/context-router.sh:117",
  "orchestrator/README.md :: .claude/settings.json:109-127",
  ...
  "orchestrator/README.md :: intake.js:922-924", // re-pinned from :797-799, then :854-856 by issue #196's own action (+57 lines), then :869-871; the Priority-as-a-field action (2026-09-12) added 37 lines to intake.js above triageBugReport's own header comment (VALID_PRIORITIES and its rationale, canonicalPriority, the contract check, the review placeholder, the priority correction branch and fileCard's applied-priority return). A TRUE pure shift: content byte-identical at :906-908, diffed line by line against the pre-action file. Shifted again to :922-924 by card #198's drop (2026-09-12), which wrote that card's whole finding into amendCard's own label block as a 16-line warning instead of leaving it parked on a closed issue -- diffed byte-identical again.
  ...
  "orchestrator/park-loop.js :: intake.js:922-924", // re-pinned from :797-799, then :854-856 by issue #196's own action (+57 lines), then :869-871; the Priority-as-a-field action (2026-09-12) added 37 lines to intake.js above triageBugReport's own header comment (VALID_PRIORITIES and its rationale, canonicalPriority, the contract check, the review placeholder, the priority correction branch and fileCard's applied-priority return). A TRUE pure shift: content byte-identical at :906-908, diffed line by line against the pre-action file. Shifted again to :922-924 by card #198's drop (2026-09-12), which wrote that card's whole finding into amendCard's own label block as a 16-line warning instead of leaving it parked on a closed issue -- diffed byte-identical again.
  ...
  "orchestrator/steps/llm.js :: intake.js:922-924", // re-pinned from :797-799, then :854-856 by issue #196's own action (+57 lines), then :869-871; the Priority-as-a-field action (2026-09-12) added 37 lines to intake.js above triageBugReport's own header comment (VALID_PRIORITIES and its rationale, canonicalPriority, the contract check, the review placeholder, the priority correction branch and fileCard's applied-priority return). A TRUE pure shift: content byte-identical at :906-908, diffed line by line against the pre-action file. Shifted again to :922-924 by card #198's drop (2026-09-12), which wrote that card's whole finding into amendCard's own label block as a 16-line warning instead of leaving it parked on a closed issue -- diffed byte-identical again.
