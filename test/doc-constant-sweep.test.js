...
const EXPECTED_CITATIONS = [
  ...
  "orchestrator/invariants.js :: doc/state-machine-spec.md:511", // MERGE (2026-09-23): same fact and same correction as the orchestrator/README.md :: doc/state-machine-spec.md entry above -- :382 is what the merged doc holds (A9's own closing-testimony correction), not main's independent :380. Card #251: :382 -> :438, same shift as the orchestrator/README.md entry above. Card #255: :438 -> :463, same shift as the orchestrator/README.md entry above. Card #279: :463 -> :507, then :511 in its doc round, same shifts as the orchestrator/README.md entry above.
  "orchestrator/invariants.js :: relative/path/to/file.ts:123",
...
const ANCHOR_BLUNT_CITATIONS = {
  // README.md: "`doc/state-machine-spec.md:511` has always promised CHECK runs an invariant
  ...
  // row today. Then card #251 (:380 -> :438), card #255 (:438 -> :463) and card #279 (:463 ->
  // :507 -> :511), the same pure shifts.
  'orchestrator/README.md :: doc/state-machine-spec.md:511':
    ...
    'Citation confirmed correct by hand: 511 is the CHECK row.',
...
const EXPECTED_DISCRIMINATING_CITATIONS = [
  ...
  'orchestrator/invariants.js :: doc/state-machine-spec.md:511',
...
const EXPECTED_BENCH_PIN_KEYS = [
  ...
  "doc/bench-audit-2026-09-02.md :: doc/state-machine-spec.md:518 @ HEAD",
  ...
  "doc/bench-plan-derived-2026-09-02.md :: doc/state-machine-spec.md:518 @ HEAD",
...
const EXPECTED_LIVE_PIN_KEYS = [
  ...
  "orchestrator/README.md :: doc/state-machine-spec.md:511 @ HEAD",
...
const DATED_DOC_HEAD_EXCEPTIONS = new Set([
  ...
  "doc/bench-audit-2026-09-02.md :: doc/state-machine-spec.md:518", // the FINISH row -- hand-maintained as true today, not dated record (BENCH_PINS header); re-pinned from :166 by main's own card #212 merge, a true pure shift
  "doc/bench-plan-derived-2026-09-02.md :: doc/state-machine-spec.md:518", // same fact, same reason, cited from the sibling doc
]);
