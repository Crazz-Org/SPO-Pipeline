...
test('every contract promptFile exists under prompts/ and every non-review-card prompt file is used by exactly one contract', () => {
  ...
  const expected = allPromptFiles.filter((f) => f !== 'review-card.md').sort();
