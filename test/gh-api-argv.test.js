...
test('blankComments: an opener inside a `//` comment does not swallow the gh api call sites around it', () => {
  ...
  //     orchestrator/state-machine.js:225 and orchestrator/config.js:978 are two of them. (Re-pinned
  //     from :916 for action A2, card #239, 2026-09-17: a +62-line shift landed above this point in
...
test('the -f/--method sweep still catches a genuine violation even in the presence of a slash-star inside a // comment', () => {
