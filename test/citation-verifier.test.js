...
test('handleValidate: rdoDiffTouched as a non-boolean ("false" string or 0) is not coerced -- falls through to the journal fallback instead of being treated as false', async () => {
  for (const nonBooleanValue of ['false', 0]) {
    ...
    // strict-equality class of bug measured at step-contracts.js:1048's shouldEscalate. (Re-pinned
    // from :999 for action A2, card #239, 2026-09-17 -- a +49-line shift; content byte-identical
    // at :1048, verified by re-reading the target line.)
